...
replace (
	...
	github.com/rancher/rancher/pkg/apis => github.com/cnrancher/pandaria/pkg/apis v0.0.0-20260511013248-eec5d3706cd7
)
...
require (
	...
	github.com/cnrancher/cce-operator v0.10.0
